...
# Importado de app.utils.notif_helpers para ser reutilizável por qualquer
# worker futuro sem precisar duplicar o padrão try/except.

from ..utils.notif_helpers import fetch_with_notif_fallback as _fetch_with_notif_fallback  # noqa: E402
